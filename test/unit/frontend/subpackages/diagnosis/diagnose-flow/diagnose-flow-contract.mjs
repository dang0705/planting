...
const flowSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/DiagnoseFlow.vue'),
  'utf8'
)
const flowSetupSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/setup.js'),
  'utf8'
)
...
const questionFlowSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/question-flow.js'),
  'utf8'
)
const riskSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/question-risk.js'),
  'utf8'
)
...
const questionPackageSectionSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/DiagnoseQuestionPackageSection.vue'),
  'utf8'
)
const retakeCopySource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/retake-copy.js'),
  'utf8'
)
const diagnoseStateSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/state.js'),
  'utf8'
)
const diagnoseImagesSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/images.js'),
  'utf8'
)
...
const retakeExpirySource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/diagnose-flow/retake-expiry.js'),
  'utf8'
)
...
const answerMutationSource = fs.readFileSync(
  path.join(
    repoRoot,
    'src/subpackages/diagnosis/vue-query/diagnose/mutations/useDiagnosisAnswerMutation.js'
  ),
  'utf8'
)
const popupSource = fs.readFileSync(
  path.join(repoRoot, 'src/subpackages/diagnosis/components/DiagnosePopup.vue'),
  'utf8'
)
...
assert.doesNotMatch(questionPackageSectionSource, /后端重新判断/)
