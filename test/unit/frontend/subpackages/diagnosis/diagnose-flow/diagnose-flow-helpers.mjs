...
} from '../../../../../../src/subpackages/diagnosis/diagnose-flow/retake-clock.js'
import { buildRetakeConfirmationContent } from '../../../../../../src/subpackages/diagnosis/diagnose-flow/retake-copy.js'
import { isRetakeWindowExpiredError } from '../../../../../../src/subpackages/diagnosis/diagnose-flow/retake-expiry.js'
import { resolveRiskSkipAction } from '../../../../../../src/subpackages/diagnosis/diagnose-flow/question-skip.js'
import {
  buildDirectionChoicePayload,
  shouldAutoSelectDirectionChoice
} from '../../../../../../src/subpackages/diagnosis/diagnose-flow/direction-choice-payload.js'
import {
  shouldNavigateDiagnosisResult,
  shouldNavigateQuestionPackage
} from '../../../../../../src/subpackages/diagnosis/diagnose-flow/question-package-navigation.js'
import {
  buildAuthorizedRetakeResult,
  buildRetakeImageAnswerPayload,
  preserveDiagnosisContinuationContext,
  resolveRetakeUploadSlotType
} from '../../../../../../src/subpackages/diagnosis/diagnose-flow/retake-continuation.js'
import { useDiagnoseQuestionText } from '../../../../../../src/subpackages/diagnosis/diagnose-flow/question-text.js'
import { normalizeDiagnosisResult } from '../../../../../../src/subpackages/diagnosis/utils/diagnose-result-normalizer.js'
...
const retakeRequestHelperSource = readFileSync(
...
const dialogSubmitSource = readFileSync(
  'src/subpackages/diagnosis/diagnose-flow/dialog-submit.js',
  'utf8'
)
const inlineQuestionFlowSource = readFileSync(
  'src/subpackages/diagnosis/diagnose-flow/question-flow.js',
  'utf8'
)
