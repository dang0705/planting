...
const pageFlowSource = readFileSync(
  'src/subpackages/diagnosis/question-package/question-flow.js',
  'utf8'
)
const packagePageSource = readFileSync('src/subpackages/diagnosis/question-package.vue', 'utf8')
const answerPayloadSource = readFileSync(
  'src/subpackages/diagnosis/utils/diagnose-question-answer-payload.js',
  'utf8'
)
