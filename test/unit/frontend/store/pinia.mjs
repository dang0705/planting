...
import { usePlantingStore } from '../../../../src/store/planting.js'
...
try {
  ...
  plantingStore.setReminderFocus({ plantId: 1, plantName: '绿萝', type: 'water' })
  assert.deepEqual(plantingStore.consumeReminderFocus(), {
    plantId: '1',
    plantName: '绿萝',
    type: 'water'
  })
  assert.equal(plantingStore.consumeReminderFocus(), null)
