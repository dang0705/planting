...
const identifySource = fs.readFileSync(
  path.join(root, 'src/composables/useUserPlantIdentify.js'),
  'utf8'
)
...
console.log(
  'plant identify shared composable paid access source contracts passed data_mode=unit_fake test_kind=source_contract'
)
