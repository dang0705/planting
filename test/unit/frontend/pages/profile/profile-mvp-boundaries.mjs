...
assert.doesNotMatch(source, /UserPlantsSection|userPlantsRef/)
assert.doesNotMatch(source, /profile-menu-\$\{item\.action\}/)
...
assert.doesNotMatch(source, /url: '\/pages\/index\/index'/)
