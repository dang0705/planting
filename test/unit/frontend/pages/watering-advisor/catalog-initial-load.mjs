...
const pageSource = readFileSync('src/pages/watering-advisor/watering-advisor.vue', 'utf8')
const searchSource = readFileSync(
  'src/pages/watering-advisor/components/CatalogPlantSearch.vue',
  'utf8'
)
...
assert.match(pageSource, /function loadInitialCatalog\(\) \{[\s\S]*searchRef\.value\?\.loadPlants\(''\)/)
