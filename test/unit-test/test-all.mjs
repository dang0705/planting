...
async function runAllTests() {
  const tests = [
    { command: 'test/unit-test/test-pinia.mjs', name: 'Pinia 状态管理' },
    { command: 'test/unit-test/test-tailwind.mjs', name: 'Tailwind CSS' },
    { command: 'test/unit-test/test-route-planning.mjs', name: 'Route Planning' },
    { command: 'test/unit-test/test-route-sql.mjs', name: 'Route SQL' },
    { command: 'test/e2e/verify-route-golden-manifest.mjs', name: 'Route Golden Manifest' }
  ]
