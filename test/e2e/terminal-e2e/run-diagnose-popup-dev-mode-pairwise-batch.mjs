...
const DEFAULT_REPORT_FILE = 'test/e2e/terminal-e2e/manifests/diagnose-popup-dev-mode-pairwise.report.json'
const DEFAULT_BATCH_ARTIFACTS_DIR = 'test/e2e/terminal-e2e/batch'
const DEFAULT_CONCLUSION_ARTIFACTS_DIR = 'test/e2e/terminal-e2e/conclusion'
...
function buildBatchRecord(runResult, { batchGeneratedAt = new Date().toISOString() } = {}) {
  ...
  return {
    ...
    sampleAbsolutePath: path.join(projectRoot, 'test/e2e/terminal-e2e', SCRIPT_NAME),
