...
description: Use this skill for CloudBase Node.js backend, cloud functions, CloudRun, serverless APIs, scheduled jobs, LLM proxies, AI orchestration, text generation, streaming text, and Hunyuan image generation through @cloudbase/node-sdk. Prefer ai-model-web for browser or page-facing chat UI. Prefer ai-model-wechat for WeChat Mini Program.
version: 2.18.0
alwaysApply: false
---
