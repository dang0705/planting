---
name: local-smoke-test-and-lan-direct-connection-policy
description: "当 ticket / prompt / 验收出现“本地 HTTP smoke”或“LAN direct HTTP”路径时，QA 需特别校验请求头与认证参数是否齐备，避免把测试构造问题误判为产品问题"
---
