...
WHERE question_key = 'q_observed_probe__leaf_yellowing__yellowing_primary_clue_condition';
...
REPLACE INTO diagnosis_outcomes (
  ...
  ('structural_damage_old_injury', 'structural_damage_old_injury', '结构损伤/既有伤', 'care_cluster', 'structural', '结构损伤/既有伤', '当前更像既有伤或机械结构损伤，不是继续扩散的问题。', 'action_old_injury_basic', 'low', 1, 0, 1, 1, 70, 'audited', 'active'),
...
REPLACE INTO outcome_action_profiles (
  ...
  ('action_old_injury_basic', '以观察为主', JSON_ARRAY('先保持养护稳定'), JSON_ARRAY('3 天内观察是否继续扩大'), JSON_ARRAY('7 天内确认无新增缺损'), JSON_ARRAY('不要把既有伤直接当虫害反复处理'), JSON_ARRAY('若新增孔洞继续出现，再补拍复核'), 'respect_genus_care_profile', 'audited', 'active'),
...
REPLACE INTO outcome_route_groups (
  ...
  ('holes_in_leaf_split_group', '孔洞分流组', '叶片孔洞时区分既有伤与虫害取食。', JSON_ARRAY('holes_in_leaf'), JSON_ARRAY('structural_damage_old_injury', 'chewing_pest_damage'), 'q_observed_probe__holes_in_leaf__structural_cause', 2, '先区分结构既有伤还是仍在继续发生的取食痕迹。', 1, 'audited', 'active');
...
REPLACE INTO outcome_route_conditions (
  ...
  ('wet_soil_confirmation_condition', 'yellowing_wet_soil_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('leaf_yellowing', 'uniform_yellowing', 'yellow_lower_leaves', 'yellow_new_leaves', 'interveinal_chlorosis')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__yellowing_care_area_condition:watering_area', 'q_observed_probe__leaf_yellowing__watering_frequency_context:often_wet'), 'routeKeys', JSON_ARRAY('yellowing_wet_soil_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__watering_frequency_context:often_dry', 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition:light_area')), JSON_ARRAY('underwatering'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'wet_soil_confirmed', '黄叶进入浇水分流且背景长期偏湿，支持积水/根系压力。', 95, 1, 'audited', 'active'),
  ('dry_soil_confirmation_condition', 'yellowing_dry_soil_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('leaf_yellowing', 'uniform_yellowing', 'yellow_lower_leaves', 'yellow_new_leaves', 'interveinal_chlorosis')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__yellowing_care_area_condition:watering_area', 'q_observed_probe__leaf_yellowing__watering_frequency_context:often_dry'), 'routeKeys', JSON_ARRAY('yellowing_dry_soil_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__watering_frequency_context:often_wet', 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition:light_area')), JSON_ARRAY('overwatering_root_pressure'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'dry_soil_confirmed', '黄叶进入浇水分流且背景长期偏干，支持缺水压力。', 95, 1, 'audited', 'active'),
  ('old_leaf_aging_condition', 'yellowing_old_leaf_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('leaf_yellowing', 'uniform_yellowing', 'yellow_lower_leaves')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__yellowing_leaf_age_pattern:old_lower_leaves_first'), 'routeKeys', JSON_ARRAY('yellowing_old_leaf_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__yellowing_leaf_age_pattern:new_leaves_first')), JSON_ARRAY(), 'probable', 'display_outcome', 'uncertain', 'uncertain', 'old_leaf_aging_confirmed', '主要是老叶或下位叶先黄，更符合自然代谢。', 84, 1, 'audited', 'active'),
  ('yellowing_low_light_condition', 'yellowing_low_light_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('leaf_yellowing', 'uniform_yellowing', 'yellow_lower_leaves', 'yellow_new_leaves', 'interveinal_chlorosis')), JSON_OBJECT('lightHealthDirections', JSON_ARRAY('low'), 'lightHealthLevels', JSON_ARRAY('略不足', '明显不足', '严重不足'), 'fallbackQuestionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__light_change_context:weaker_light'), 'routeKeys', JSON_ARRAY('yellowing_low_light_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__light_change_context:stronger_direct_light', 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition:watering_area')), JSON_ARRAY(), 'probable', 'display_outcome', 'uncertain', 'uncertain', 'yellowing_low_light_confirmed', '黄叶进入光照分流，且光照健康度 evidence 显示低于属级需求；未携带新字段时回退近期更阴答案。', 83, 1, 'audited', 'active'),
  ('yellowing_sunburn_condition', 'yellowing_sunburn_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('leaf_yellowing', 'uniform_yellowing', 'yellow_lower_leaves', 'yellow_new_leaves', 'interveinal_chlorosis')), JSON_OBJECT('lightHealthDirections', JSON_ARRAY('strong'), 'lightHealthLevels', JSON_ARRAY('略偏强', '明显偏强', '严重偏强'), 'fallbackQuestionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__light_change_context:stronger_direct_light'), 'routeKeys', JSON_ARRAY('yellowing_sunburn_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_observed_probe__leaf_yellowing__light_change_context:weaker_light', 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition:watering_area')), JSON_ARRAY(), 'probable', 'display_outcome', 'uncertain', 'uncertain', 'yellowing_sunburn_confirmed', '黄叶进入光照分流，且光照健康度 evidence 显示高于属级需求；未携带新字段时回退近期直射增强答案。', 82, 1, 'audited', 'active'),
  ('low_light_condition', 'leggy_low_light_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('leggy_growth', 'weak_light')), JSON_OBJECT(), JSON_OBJECT(), JSON_ARRAY(), 'confirmed', 'display_outcome', 'uncertain', 'uncertain', 'low_light_confirmed', '徒长并伴随弱光，更符合光照不足/生长偏弱。', 88, 1, 'audited', 'active'),
  ('sunburn_condition', 'sunburn_recent_exposure_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('scorching_spots', 'recent_strong_sun')), JSON_OBJECT(), JSON_OBJECT(), JSON_ARRAY(), 'confirmed', 'display_outcome', 'uncertain', 'uncertain', 'sunburn_confirmed', '焦斑与近期暴晒一致，更符合晒伤/强光刺激。', 90, 1, 'audited', 'active'),
  ('dry_air_condition', 'dry_air_leaf_edge_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('burnt_leaf_edge', 'dry_air_condition')), JSON_OBJECT(), JSON_OBJECT(), JSON_ARRAY(), 'confirmed', 'display_outcome', 'uncertain', 'uncertain', 'dry_air_confirmed', '焦边与干空气背景一致，更符合环境压力。', 82, 1, 'audited', 'active'),
  ('leaf_spot_condition', 'leaf_spot_humid_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('spreading_spots', 'poor_ventilation')), JSON_OBJECT(), JSON_OBJECT(), JSON_ARRAY(), 'confirmed', 'display_outcome', 'uncertain', 'uncertain', 'leaf_spot_confirmed', '斑点扩散且通风差，更符合叶斑类问题。', 86, 1, 'audited', 'active'),
  ('old_injury_condition', 'holes_old_injury_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('holes_in_leaf', 'no_pest_trace', 'not_spreading')), JSON_OBJECT(), JSON_OBJECT('symptomKeys', JSON_ARRAY('visible_pest_trace')), JSON_ARRAY('chewing_pest_damage'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'old_injury_confirmed', '孔洞没有继续扩散且缺少虫迹，更像结构损伤或既有伤。', 80, 1, 'audited', 'active'),
  ('chewing_pest_condition', 'holes_chewing_pest_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('holes_in_leaf', 'visible_pest_trace')), JSON_OBJECT(), JSON_OBJECT(), JSON_ARRAY('structural_damage_old_injury'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'chewing_pest_confirmed', '孔洞伴随虫迹，更像咀嚼型虫害痕迹。', 93, 1, 'audited', 'active'),
  ('wilting_wet_condition', 'wilting_wet_soil_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('wilting')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_root_rot_wet_soil_wilt:yes')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_root_rot_wet_soil_wilt:no')), JSON_ARRAY('underwatering'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'wet_wilt_confirmed', '湿土仍萎蔫，更支持积水/根系压力。', 96, 1, 'audited', 'active'),
  ('wilting_dry_condition', 'wilting_dry_soil_route', 'display', JSON_OBJECT('symptomKeys', JSON_ARRAY('wilting')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_root_rot_wet_soil_wilt:no')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_root_rot_wet_soil_wilt:yes')), JSON_ARRAY('overwatering_root_pressure'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'dry_wilt_confirmed', '干土萎蔫，更支持缺水压力。', 94, 1, 'audited', 'active');
...
REPLACE INTO outcome_route_questions (
  ...
  ('yellowing_wet_soil_route', 1, 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'wet_soil_confirmation_condition', 'critical_split', 1, 250, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_wet_soil_route', 2, 'q_observed_probe__leaf_yellowing__watering_frequency_context', 'wet_soil_confirmation_condition', 'context_probe', 1, 240, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_dry_soil_route', 1, 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'dry_soil_confirmation_condition', 'critical_split', 1, 250, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_dry_soil_route', 2, 'q_observed_probe__leaf_yellowing__watering_frequency_context', 'dry_soil_confirmation_condition', 'context_probe', 1, 240, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_old_leaf_route', 1, 'q_observed_probe__leaf_yellowing__yellowing_leaf_age_pattern', 'old_leaf_aging_condition', 'critical_split', 1, 230, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_low_light_route', 1, 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'yellowing_low_light_condition', 'critical_split', 1, 250, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_low_light_route', 2, 'q_observed_probe__leaf_yellowing__light_change_context', 'yellowing_low_light_condition', 'context_probe', 1, 240, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_sunburn_route', 1, 'q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'yellowing_sunburn_condition', 'critical_split', 1, 250, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('yellowing_sunburn_route', 2, 'q_observed_probe__leaf_yellowing__light_change_context', 'yellowing_sunburn_condition', 'context_probe', 1, 240, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('holes_old_injury_route', 1, 'q_observed_probe__holes_in_leaf__structural_cause', 'old_injury_condition', 'critical_split', 1, 90, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('holes_chewing_pest_route', 1, 'q_holes_in_leaf_confirm', 'chewing_pest_condition', 'critical_split', 1, 92, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('wilting_wet_soil_route', 1, 'q_root_rot_wet_soil_wilt', 'wilting_wet_condition', 'critical_split', 1, 96, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('wilting_dry_soil_route', 1, 'q_root_rot_wet_soil_wilt', 'wilting_dry_condition', 'critical_split', 1, 96, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active');
...
REPLACE INTO outcome_answer_effects (
  ...
  ('q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'watering_area', 'overwatering_root_pressure', 'yellowing_wet_soil_route', 'support', 0.3500, '', 'care_area_condition', '养护分流进入浇水方向，继续判断是否过湿。', 1, 'audited', 'active'),
  ('q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'watering_area', 'underwatering', 'yellowing_dry_soil_route', 'support', 0.3500, '', 'care_area_condition', '养护分流进入浇水方向，继续判断是否缺水。', 1, 'audited', 'active'),
  ('q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'light_area', 'low_light_growth_weakness', 'yellowing_low_light_route', 'support', 0.3500, '', 'care_area_condition', '养护分流进入光照方向，继续判断是否弱光。', 1, 'audited', 'active'),
  ('q_observed_probe__leaf_yellowing__yellowing_care_area_condition', 'light_area', 'sunburn', 'yellowing_sunburn_route', 'support', 0.3500, '', 'care_area_condition', '养护分流进入光照方向，继续判断是否强光刺激。', 1, 'audited', 'active'),
  ...
  ('q_observed_probe__holes_in_leaf__structural_cause', 'old_injury', 'structural_damage_old_injury', 'holes_old_injury_route', 'support', 1.0000, '', 'structural_cause', '用户确认更像既有伤，支持结构损伤/既有伤。', 1, 'audited', 'active'),
...
-- doc04补强：补齐 stable_natural_marking / uncertain_observation 的 question-route-condition-answer_effect 链路
...
REPLACE INTO outcome_route_conditions (
  ...
  ('stable_natural_marking_condition', 'stable_natural_marking_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('stable_natural_marking_pattern')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_non_problematic_variegation_stability:stable_for_weeks'), 'routeKeys', JSON_ARRAY('stable_natural_marking_route')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_non_problematic_variegation_stability:expanding_or_uncertain')), JSON_ARRAY('uncertain_observation'), 'confirmed', 'display_outcome', 'ask_next', 'uncertain', 'stable_natural_marking_confirmed', '斑纹长期稳定且无扩展，更符合艺斑/正常斑纹。', 90, 1, 'audited', 'active'),
  ('uncertain_observation_condition', 'uncertain_observation_route', 'display', JSON_OBJECT('anySymptomKeys', JSON_ARRAY('stable_natural_marking_pattern', 'irregular_blotches')), JSON_OBJECT('questionOptionPairs', JSON_ARRAY('q_non_problematic_variegation_stability:expanding_or_uncertain'), 'routeKeys', JSON_ARRAY('uncertain_observation_route')), JSON_OBJECT(), JSON_ARRAY('stable_natural_marking'), 'probable', 'display_outcome', 'uncertain', 'uncertain', 'uncertain_observation_confirmed', '斑纹稳定性证据不足或存在扩展，转入保守不确定观察。', 65, 1, 'audited', 'active');
...
REPLACE INTO outcome_route_questions (
  ...
  ('stable_natural_marking_route', 1, 'q_non_problematic_variegation_stability', 'stable_natural_marking_condition', 'critical_split', 1, 200, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active'),
  ('uncertain_observation_route', 1, 'q_non_problematic_variegation_stability', 'uncertain_observation_condition', 'critical_split', 1, 195, JSON_OBJECT(), 'never_repeat', 1, 'audited', 'active');
