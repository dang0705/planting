CREATE TABLE IF NOT EXISTS symptom_classes (
  ...
  followup_enabled_v1 TINYINT(1) NOT NULL DEFAULT 0 COMMENT '既有版 follow-up 开关，仅适配保留',
  ...
  runtime_condition_rule VARCHAR(255) NOT NULL DEFAULT '' COMMENT '运行时 condition 规则',
