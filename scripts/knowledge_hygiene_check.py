...
AREAS: tuple[Area, ...] = (
    ...
    Area(
        ...
        patterns=("package.json", "scripts/dev/**", "scripts/deploy-*.mjs", "scripts/security/**", "scripts/terminal-e2e/**", "cloudfunctions/**/package.json", "cloudfunctions/**/cloudbase-functions.json"),
