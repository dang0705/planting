...
assert.ok(componentSource.includes('diagnose-care-behavior-action-fertilize-${selectedDateState.date}'))
assert.ok(componentSource.includes('diagnose-care-behavior-action-light-${selectedDateState.date}'))
assert.ok(componentSource.includes('care-behavior-action-row'))
...
assert.ok(compactComponentSource.includes('line-height: 15px'))
assert.ok(compactComponentSource.includes('gap: 2px'))
assert.ok(compactComponentSource.includes('width: 10px; height: 10px'))
assert.ok(compactComponentSource.includes('background: rgba(241, 248, 244, 0.5)'))
assert.ok(compactComponentSource.includes('font-size: 10px; color: #5a7a68'))
assert.ok(compactComponentSource.includes('box-shadow: 0 6px 18px rgba(15, 23, 42, 0.08)'))
assert.ok(compactComponentSource.includes('温度'))
assert.ok(compactComponentSource.includes('湿度'))
assert.ok(compactComponentSource.includes('行为'))

assert.ok(followUpPageSource.includes('followup-topbar'))
assert.ok(followUpPageSource.includes('继续诊断'))
