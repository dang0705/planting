...
- package answer submit 是终止当前问诊轮次的提交形态；停止与输出资格由 stop state、output eligibility、无 active queue、正式 outcome type、正式 stop decision 共同决定，不是“答满若干题就输出”。
...
- 文档中出现“旧追问模式”“动态多轮 ranking 追问”“dynamic next-question helper 是当前权威”“题包按题请求”“旧数组字段是 package 主响应字段”“答题数足够即可输出”“questionQueue 拒绝有效 package sibling questions”等说法，均视为需要复核的高风险陈述。
