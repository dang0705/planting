...
- 既有的“ranking / score gap / hypothesis pool 决定追问与停止”、既有 dynamic next-question helpers、既有 active follow-up residues 不再作为当前事实使用。
...
- 文档中出现“既有追问模式”“动态多轮 ranking 追问”“dynamic next-question helper 是当前权威”“题包按题请求”“既有数组字段是 package 主响应字段”“答题数足够即可输出”“questionPackageSnapshot 拒绝有效 package sibling questions”等说法，均视为需要复核的高风险陈述。
