...
function buildSyntheticObservedProbeOptionTexts(item = {}, packageTopic = '', _context = {}) {
  ...
  switch (packageTopic) {
    ...
    case QUESTION_PACKAGE_TOPICS.STRUCTURAL_CAUSE:
      return {
        ...
        mechanical_old: '更像折伤、摩擦、既有伤或焦边裂开',
        unknown: '看不出/不确定'
      }
    case QUESTION_PACKAGE_TOPICS.PEST_TRACE_TYPE:
      return {
        ...
        no_pest_trace: '没有这些虫害痕迹，更像晒伤、肥害、既有伤或普通变色',
        unknown: '看不出/不确定'
      }
