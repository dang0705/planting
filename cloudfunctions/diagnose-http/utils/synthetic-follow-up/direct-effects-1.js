...
module.exports = {
  leaf_yellowing: {
      [QUESTION_TARGET_DIMENSIONS.HOST_CONFIRMATION]: {
        yes: [
          ...
          { problemKey: 'iron_deficiency', effectValue: -0.12 }
        ],
        no: [
          { problemKey: 'iron_deficiency', effectValue: 0.24 },
      ...
      [QUESTION_TARGET_DIMENSIONS.PROGRESSION]: {
        yes: [
          ...
          { problemKey: 'nitrogen_deficiency', effectValue: -0.08 },
          { problemKey: 'iron_deficiency', effectValue: -0.08 }
        ],
        no: [
          { problemKey: 'nitrogen_deficiency', effectValue: 0.2 },
          { problemKey: 'iron_deficiency', effectValue: 0.16 },
          { problemKey: 'low_light', effectValue: 0.14 },
      ...
      [QUESTION_TARGET_DIMENSIONS.DISTRIBUTION_SCOPE]: {
        yes: [
          ...
          { problemKey: 'aphids', effectValue: 0.1 },
          { problemKey: 'sunburn', effectValue: 0.1 }
        ],
        no: [
          { problemKey: 'chlorosis', effectValue: 0.14 },
          { problemKey: 'nitrogen_deficiency', effectValue: 0.18 },
          { problemKey: 'iron_deficiency', effectValue: 0.16 },
          { problemKey: 'low_light', effectValue: 0.12 },
          { problemKey: 'nutrient_deficiency', effectValue: 0.12 }
        ]
      },
      [QUESTION_TARGET_DIMENSIONS.LIGHT_EXPOSURE]: {
        ...
        no: [
          { problemKey: 'low_light', effectValue: 0.18 },
          { problemKey: 'iron_deficiency', effectValue: 0.08 },
      ...
      [QUESTION_TARGET_DIMENSIONS.WATERING_CONTEXT]: {
        yes: [
          ...
          { problemKey: 'underwatering', effectValue: -0.16 }
        ],
        no: [
          { problemKey: 'underwatering', effectValue: 0.24 },
          { problemKey: 'low_light', effectValue: 0.08 },
          { problemKey: 'overwatering', effectValue: -0.16 },
      ...
      [QUESTION_TARGET_DIMENSIONS.FERTILIZATION_CONTEXT]: {
        yes: [
          ...
          { problemKey: 'nutrient_deficiency', effectValue: 0.18 },
          { problemKey: 'low_light', effectValue: -0.08 }
        ],
        no: [
          { problemKey: 'low_light', effectValue: 0.12 },
          { problemKey: 'root_stress', effectValue: 0.08 },
          { problemKey: 'nitrogen_deficiency', effectValue: -0.08 },
          { problemKey: 'iron_deficiency', effectValue: -0.08 }
        ]
      }
  ...
  yellowingDifferential: {
      [QUESTION_TARGET_DIMENSIONS.YELLOWING_DISEASE_TRACE_GATE]: {
        ...
        powder_mold_surface: [
          { problemKey: 'powdery_mildew', effectValue: 0.2 },
          { problemKey: 'sooty_mold_associated_pests', effectValue: 0.12 }
        ],
        yellowing_only_no_lesion: [
          { problemKey: 'fungal_leaf_spot', effectValue: -0.1 },
          { problemKey: 'bacterial_leaf_spot', effectValue: -0.1 },
          { problemKey: 'nitrogen_deficiency', effectValue: 0.03 },
      ...
      [QUESTION_TARGET_DIMENSIONS.PEST_TRACE_TYPE]: {
        ...
        thrips_silver_black: [
          { problemKey: 'thrips', effectValue: 0.22 },
          { problemKey: 'spider_mites', effectValue: -0.08 },
          { problemKey: 'nitrogen_deficiency', effectValue: -0.08 }
        ],
        sticky_honeydew: [
          { problemKey: 'whiteflies', effectValue: 0.2 },
          { problemKey: 'aphids', effectValue: 0.18 },
          { problemKey: 'scale_insects', effectValue: 0.18 },
          { problemKey: 'sooty_mold_associated_pests', effectValue: 0.14 },
          { problemKey: 'spider_mites', effectValue: -0.12 }
        ],
        no_pest_trace: [
          { problemKey: 'spider_mites', effectValue: -0.1 },
          { problemKey: 'whiteflies', effectValue: -0.1 },
          { problemKey: 'aphids', effectValue: -0.08 },
          { problemKey: 'thrips', effectValue: -0.08 },
          { problemKey: 'low_light', effectValue: -0.02 },
      ...
      [QUESTION_TARGET_DIMENSIONS.YELLOWING_LEAF_AGE_PATTERN]: {
        ...
        old_lower_leaves_first: [
          { problemKey: 'nitrogen_deficiency', effectValue: 0.16 },
          { problemKey: 'low_light', effectValue: 0.04 },
          { problemKey: 'iron_deficiency', effectValue: -0.14 }
        ],
        no_clear_age_bias: [
          { problemKey: 'low_light', effectValue: 0.04 },
          { problemKey: 'root_stress', effectValue: 0.04 },
      ...
      [QUESTION_TARGET_DIMENSIONS.YELLOWING_DISTRIBUTION_PATTERN]: {
        uniform_whole_leaf: [
          ...
          { problemKey: 'overwatering', effectValue: 0.03 }
        ],
        interveinal: [
          { problemKey: 'iron_deficiency', effectValue: 0.28 },
          { problemKey: 'nutrient_deficiency', effectValue: 0.12 },
          { problemKey: 'nitrogen_deficiency', effectValue: -0.1 }
        ],
        patchy_or_speckled: [
        ...
        edge_or_scorch_patch: [
          { problemKey: 'sunburn', effectValue: 0.22 },
          { problemKey: 'heat_stress', effectValue: 0.14 },
      ...
      [QUESTION_TARGET_DIMENSIONS.WATERING_FREQUENCY_CONTEXT]: {
        often_wet: [
          ...
          { problemKey: 'root_rot', effectValue: 0.1 },
          { problemKey: 'underwatering', effectValue: -0.18 }
        ],
        often_dry: [
          { problemKey: 'underwatering', effectValue: 0.26 },
      ...
      [QUESTION_TARGET_DIMENSIONS.LIGHT_CHANGE_CONTEXT]: {
        stronger_direct_light: [
          ...
          { problemKey: 'low_light', effectValue: -0.16 }
        ],
        weaker_light: [
          { problemKey: 'low_light', effectValue: 0.24 },
          { problemKey: 'sunburn', effectValue: -0.14 }
        ],
        no_clear_change: [
          { problemKey: 'low_light', effectValue: -0.08 },
          { problemKey: 'sunburn', effectValue: -0.08 }
      ...
      [QUESTION_TARGET_DIMENSIONS.YELLOWING_PROGRESSION_SPEED]: {
        ...
        with_wilting_or_drop: [
          { problemKey: 'root_stress', effectValue: 0.2 },
          { problemKey: 'root_rot', effectValue: 0.12 },
          { problemKey: 'overwatering', effectValue: 0.1 }
        ]
      }
  ...
  yellow_speckling: {
      [QUESTION_TARGET_DIMENSIONS.UNDERSIDE_PRESENCE]: {
        ...
        no: [
          ...
          { problemKey: 'whiteflies', effectValue: -0.1 },
          { problemKey: 'aphids', effectValue: -0.08 },
          { problemKey: 'sunburn', effectValue: 0.12 },
      ...
      [QUESTION_TARGET_DIMENSIONS.SURFACE_STICKINESS]: {
        yes: [
          ...
          { problemKey: 'scale_insects', effectValue: 0.22 },
        ...
        no: [
          { problemKey: 'spider_mites', effectValue: -0.12 },
          { problemKey: 'thrips', effectValue: -0.08 },
          { problemKey: 'whiteflies', effectValue: -0.12 },
          { problemKey: 'aphids', effectValue: -0.12 },
      ...
      [QUESTION_TARGET_DIMENSIONS.DISTRIBUTION_SCOPE]: {
        ...
        no: [
          { problemKey: 'nutrient_deficiency', effectValue: 0.14 },
          { problemKey: 'iron_deficiency', effectValue: 0.12 },
          { problemKey: 'nitrogen_deficiency', effectValue: 0.12 },
          { problemKey: 'low_light', effectValue: 0.1 },
          { problemKey: 'spider_mites', effectValue: -0.08 }
      ...
      [QUESTION_TARGET_DIMENSIONS.HOST_CONFIRMATION]: {
        ...
        no: [
          { problemKey: 'spider_mites', effectValue: 0.04 },
          { problemKey: 'thrips', effectValue: 0.1 },
          { problemKey: 'whiteflies', effectValue: 0.08 }
        ]
      }
