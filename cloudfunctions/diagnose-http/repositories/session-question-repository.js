...
async function insertQuestionQuestionsRows(sessionId, list = []) {
...
async function listQuestionRows(sessionId) {
...
async function markQuestionAnswerRow({
  rowId,
  answerValue,
  answerConfidence,
  status
...
async function invalidateQuestionRowsAfterQuestion({
  sessionId,
  dirtyQuestionKey
} = {}) {
...
async function insertQuestionAnswerRevisionEvents({
  sessionId,
  openid = '',
  ...
  try {
    ...
    console.warn('diagnosis question answer event insert failed:', {
      sessionId,
